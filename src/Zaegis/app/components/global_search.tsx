...
const NAV_ITEMS = [
  ...
  { label: 'Standard Deployment',  href: '/dashboard/standard',            icon: FileText,         group: 'Pages' },
  ...
  { label: 'GeoData',             href: '/dashboard/geodata',            icon: Building2,        group: 'Pages' },
  { label: 'Barangay Demographics',href: '/dashboard/geodata?tab=profile',   icon: Building2,   group: 'Pages' },
  { label: 'Zoning Management',    href: '/dashboard/geodata?tab=zoning',    icon: Building2,   group: 'Pages' },
  { label: 'Boundary Shapefile',   href: '/dashboard/geodata?tab=activity',  icon: Building2,   group: 'Pages' },
  { label: 'CIRAS Report',         href: '/dashboard/ciras_rep',          icon: Upload,           group: 'Pages' },
  { label: 'MP Details',           href: '/dashboard/resources',          icon: Users,            group: 'Pages' },
  { label: 'Personnel',            href: '/dashboard/resources',          icon: Users,            group: 'Pages' },
  { label: 'Vehicles',             href: '/dashboard/resources/vehicles', icon: Car,              group: 'Pages' },
