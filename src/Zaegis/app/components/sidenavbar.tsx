...
export function SideNav({ userRole, onLinkClick }: SideNavProps) {
  ...
  const isDeploymentPath =
    pathname.startsWith("/dashboard/standard") ||
  ...
  const navItems = [
    ...
    { name: "GeoData", href: "/dashboard/geodata", icon: IconBuilding },
    { name: "Resources", href: "/dashboard/resources", icon: IconBell },
    {
      name: "Deployment",
      icon: IconReport,
      children: [
        { name: "Standard", href: "/dashboard/standard", icon: IconReport },
